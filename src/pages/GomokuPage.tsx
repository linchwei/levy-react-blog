      ...
      >
        ...
        <section className="relative py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -top-1/2 -right-1/2 w-full h-full bg-gradient-to-b from-amber-500/5 to-transparent rounded-full blur-3xl" />
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 rounded-xl bg-background border border-border/50">
                ...
                <h3 className="font-semibold mb-2">控制中心</h3>
                <p className="text-sm text-muted-foreground">
                  优先占据棋盘中心位置，拥有更多的进攻和防守选择
                </p>
              </div>
              <div className="p-6 rounded-xl bg-background border border-border/50">
                <div className="text-3xl mb-3">⚡</div>
                <h3 className="font-semibold mb-2">活三活四</h3>
                <p className="text-sm text-muted-foreground">
                  创造两端都开放的连续棋子，增加获胜机会
                </p>
              </div>
              <div className="p-6 rounded-xl bg-background border border-border/50">
                ...
                <h3 className="font-semibold mb-2">攻守兼备</h3>
                <p className="text-sm text-muted-foreground">
                  既要积极进攻，也要注意防守对手的威胁
                </p>
              </div>
