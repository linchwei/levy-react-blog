      ...
      >
        ...
        <section className="relative py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -top-1/2 -right-1/2 w-full h-full bg-gradient-to-b from-red-500/5 to-transparent rounded-full blur-3xl" />
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 rounded-xl bg-background border border-border/50">
                ...
                <p className="text-sm text-muted-foreground">
                  球击中挡板不同位置会改变反弹角度，利用这点控制球的方向
                </p>
              </div>
              <div className="p-6 rounded-xl bg-background border border-border/50">
                <div className="text-3xl mb-3">⚡</div>
                <h3 className="font-semibold mb-2">优先消除</h3>
                <p className="text-sm text-muted-foreground">
                  优先击碎上方的砖块，避免球掉落时来不及反应
                </p>
              </div>
              <div className="p-6 rounded-xl bg-background border border-border/50">
