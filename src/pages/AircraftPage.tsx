...
import { AircraftGame } from '@/components/games/aircraft/AircraftGame'
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 rounded-xl bg-background border border-border/50">
                ...
                <h3 className="font-semibold mb-2">灵活移动</h3>
                <p className="text-sm text-muted-foreground">
                  保持移动，不要停留在同一位置，躲避敌机和子弹
                </p>
              </div>
              <div className="p-6 rounded-xl bg-background border border-border/50">
                <div className="text-3xl mb-3">💣</div>
                <h3 className="font-semibold mb-2">善用炸弹</h3>
                <p className="text-sm text-muted-foreground">
                  危急时刻使用炸弹清屏，保命要紧
                </p>
              </div>
              <div className="p-6 rounded-xl bg-background border border-border/50">
                <div className="text-3xl mb-3">⚡</div>
                <h3 className="font-semibold mb-2">拾取道具</h3>
                <p className="text-sm text-muted-foreground">
                  P增强火力，B增加炸弹，L增加生命
                </p>
              </div>
