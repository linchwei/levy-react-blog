    ...
    (set, get) => ({
      ...
      fetchData: async () => {
        ...
        try {
          ...
          const mockTimelineData: TimelineEventJSON[] = [
            {
              ...
              company: '字节跳动',
              location: '北京',
              description: '负责抖音电商核心交易系统前端架构设计与优化，主导微前端架构升级，支撑日均亿级流量。带领15人前端团队，建立完整的前端工程化体系和技术规范。',
              highlights: [
              ...
              type: 'work',
              icon: 'rocket',
              tech: ['React', 'TypeScript', 'Micro-Frontend', 'Webpack', 'Node.js', 'Rust'],
              metrics: [
            ...
            },
            {
              ...
              company: '阿里巴巴',
              location: '杭州',
              description: '加入淘宝核心交易团队，负责购物车、订单确认等核心链路前端开发。主导前端性能优化专项，推动团队技术升级至React 18 + TypeScript全栈方案。',
              highlights: [
              ...
              type: 'work',
              icon: 'briefcase',
              tech: ['React', 'Next.js', 'TypeScript', 'GraphQL', 'Docker', 'Kubernetes'],
              metrics: [
                { label: '代码重构', value: '40%' },
                { label: '性能提升', value: '70%' },
            ...
            },
            {
              ...
              company: '腾讯',
              location: '深圳',
              description: '参与微信读书Web端开发，负责阅读器核心功能实现。优化大文档渲染性能，解决长列表卡顿问题，提升用户阅读体验。',
              highlights: [
            ...
            },
            {
              ...
              company: '美团',
              location: '北京',
              description: '加入美团外卖前端团队，负责商家端管理系统开发。从0到1搭建前端工程化体系，推动团队从jQuery向Vue.js技术栈迁移。',
              highlights: [
                '完成前端技术栈升级，开发效率提升50%',
            ...
            },
            {
              ...
              company: '浙江大学',
              location: '杭州',
              description: '985高校计算机专业，GPA 3.9/4.0，专业排名前5%。主修课程：数据结构与算法、操作系统、计算机网络、数据库系统、软件工程。',
              highlights: [
                '获得国家奖学金（专业前1%）',
                'ACM程序设计竞赛区域赛银牌',
                '发表CCF-B类论文1篇',
            ...
            },
            {
              ...
              description: '高性能React虚拟列表组件库，支持百万级数据流畅渲染。GitHub Star 5.2k+，npm周下载量10万+，被多家大厂采用。',
              highlights: [
            ...
            },
            {
              ...
              description: '轻量级微前端框架，支持多种技术栈混合开发。解决大型应用拆分解耦问题，已在生产环境验证，支撑千万级用户产品。',
              highlights: [
              ...
              type: 'project',
              icon: 'layers',
              tech: ['JavaScript', 'Web Components', 'Proxy', 'Shadow DOM', 'Webpack'],
              metrics: [
            ...
            },
            {
              ...
              description: '一站式DevOps可视化平台，集成CI/CD、监控告警、日志分析等功能。帮助团队提升研发效能，缩短交付周期。',
              highlights: [
              ...
              type: 'project',
              icon: 'cloud',
              tech: ['React', 'D3.js', 'Node.js', 'Docker', 'Prometheus', 'Grafana'],
              metrics: [
            ...
            },
            {
              ...
              title: '2023年度优秀技术专家',
              company: '字节跳动',
              description: '因在电商交易系统架构优化中的突出贡献，获得公司级年度优秀技术专家称号。表彰在微前端架构、性能优化、团队建设等方面的卓越成就。',
              highlights: [
            ...
            },
            {
              ...
              title: '开源贡献者之星',
              company: 'GitHub',
              description: '因在开源社区的持续贡献，获得GitHub Arctic Code Vault贡献者认证。多个开源项目累计Star数超过1万，影响开发者数万人。',
              highlights: [
                '维护5个高质量开源项目',
                '累计贡献代码10万+行',
                '撰写技术博客50+篇，阅读量百万+',
            ...
            },
            {
              ...
              description: '在QCon大会分享《亿级流量下的前端架构实践》，获得最佳演讲者称号。分享内容涵盖微前端、性能优化、工程化等实战经验。',
              highlights: [
                '演讲评分4.9/5.0，全场最高',
                '现场听众1000+，线上观看10万+',
                '演讲内容被多家技术媒体转载',
          ...
          const mockPostsData: BlogPostJSON[] = [
            {
              id: '1',
              slug: 'micro-frontend-practice',
              title: '微前端架构在亿级流量场景的实践',
              excerpt: '分享字节跳动电商团队在微前端架构升级中的实战经验，包括技术选型、性能优化、团队协作等方面的深度思考。',
              content: '# 微前端架构在亿级流量场景的实践\n\n## 背景\n\n随着业务的快速发展，我们的前端应用变得越来越庞大...',
              coverImage: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&h=400&fit=crop',
              category: '架构',
              tags: ['微前端', '架构设计', '性能优化', 'React'],
            ...
            },
            {
              ...
              title: '前端性能优化的系统性方法论',
              excerpt: '从网络、渲染、运行时三个维度，系统性地讲解前端性能优化的方法论和实战技巧。',
              content: '# 前端性能优化的系统性方法论\n\n## 性能指标\n\n首先我们需要了解如何衡量性能...',
              coverImage: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=800&h=400&fit=crop',
              category: '性能',
              tags: ['性能优化', 'Web Vitals', 'Chrome DevTools'],
            ...
            },
            {
              ...
              title: '深入理解React 18并发模式',
              excerpt: '全面解析React 18的并发特性，包括Suspense、Transitions、Automatic Batching等核心概念。',
              content: '# 深入理解React 18并发模式\n\n## 什么是并发\n\n并发是React 18最重要的特性之一...',
          ...
          const mockSkillsData: Skill[] = [
            {
              ...
              category: 'frontend',
              icon: 'react',
              description: '精通React生态，包括Hooks、Concurrent Mode、Server Components等高级特性'
            },
            {
              name: 'TypeScript',
              level: 95,
            ...
            },
            {
              ...
              category: 'frontend',
              icon: 'vue',
              description: '熟练使用Vue 2/3，包括Composition API、Pinia状态管理等'
            },
            {
              name: 'Node.js',
              level: 88,
            ...
            },
            {
              ...
              category: 'devops',
              icon: 'docker',
              description: '熟练使用容器化技术，能够编写Dockerfile和Compose配置'
            },
            {
              name: 'Kubernetes',
              level: 80,
          ...
          set({
            posts: mockPostsData.map(parsePostDates),
